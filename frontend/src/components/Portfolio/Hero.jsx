const SOCIALS = [
  ...
  { label: 'Email', href: 'mailto:you@example.com', icon: 'M2 4h20v16H2V4Zm2 2v.01L12 12l8-5.99V6H4Zm16 2.24-7.4 5.55a1 1 0 0 1-1.2 0L4 8.24V18h16V8.24Z' },
];
    ...
    <section id="home" className="hero">
      <div className="hero__inner">
        <div className="hero__text">
          <p className="eyebrow">Hey, I'm Your Name</p>
